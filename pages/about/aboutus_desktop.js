        ...
        <div className={styles.aboutus_Wrapper}>
            ...
            {index == 2 &&
                <div>
                    <article style={{ width: "70%", margin: "auto" }}>
                        <h2>Our promise </h2>
                        <p>At Jainam Jewellers, we stand by our promise! We make sure to deliver assurance by keeping our words in every possible way. Here is what we promise to our valuable clients.</p>
                        <h3>Guarantee on metal’s purity</h3>
                        <p>We stay true to our roots by delivering the most authentic Gold. Our Metals in ornaments are 100% pure, extracted naturally from the ores. From our initial days of business, we have focused on customer satisfaction. Metal’s purity is one quality that marks us preeminent.</p>
                        <h3>Fair pricing policy</h3>
                        <p>We come recommended when it is about the pricing! Our pricing from day one has always been fair as per the market standards. We believe in winning trust with transparency in business.</p>
                        <h3>Timely Delivery</h3>
                        <p>On-time delivery of customized and ordered ornaments is one more quality that defines us. We offer you the ornament of your choice at the time that you say!</p>
                        <h3>Quality assurance on finished product</h3>
                        <p>We have always focused on doing every bit with authenticity and precision. This belief in us has ignited us to deliver quality that we have never found before. The finished products we deliver are beyond words to describe. The designs and patterns in our end products define craftsmanship in jewelry.</p>
                    </article>
                    <button onClick={() => setIndex(0)}>{`Go Back`}</button>
                </div>
            }
            ...
            {index == 6 &&
                <div>
                    <article style={{ width: "70%", margin: "auto" }}>
                        <h2>Our team</h2>
                        <h3></h3>
                        <p>Tushar Gandhi aspired to bring a reliable platform for authentic Jewelry. With his passion for bringing the classic pieces of Jewelry, he satisfies every client. Moreover, he brings the new marketing strategies that enable Jainam Jewellers to achieve new heights. Client satisfaction has always been the primary aim of Tushar Gandhi. From 1987 to the present, he himself ensures about all the aspects responsible for the business's improvement. He believes that Ornaments mark prosperity! So, he delivers striking pieces of Jewelry to the clients.</p>
